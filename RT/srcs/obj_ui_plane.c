...
/*   Updated: 2019/03/19 16:10:01 by oponomar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			init_plane_ui(t_ui_panel *panel, t_objlst *selected)
{
	selected->ui_form_amount = 10;
	kiss_label_new(&selected->title, &panel->panel, "Plane",
					UI_STEP_X, UI_Y);
