...
/*   Updated: 2019/03/19 16:05:47 by oponomar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			init_cyl_ui(t_ui_panel *panel, t_objlst *selected)
{
	selected->ui_form_amount = 11;
	kiss_label_new(&selected->title, &panel->panel, "Cylinder",
					UI_STEP_X, UI_Y);
