...
/*   Updated: 2019/03/19 16:10:28 by oponomar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				init_hemisphere_ui(t_ui_panel *panel, t_objlst *selected)
{
	selected->ui_form_amount = 11;
	kiss_label_new(&selected->title, &panel->panel, "Hemisphere",
					UI_STEP_X, UI_Y);
	...
	update_hemisphere_entries(selected);
}
