...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/03/18 12:48:55 by oponomar          #+#    #+#             */
/*   Updated: 2019/03/19 16:10:39 by oponomar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			init_disk_ui(t_ui_panel *panel, t_objlst *selected)
{
	selected->ui_form_amount = 11;
	kiss_label_new(&selected->title, &panel->panel, "Disk",
					UI_STEP_X, UI_Y);
