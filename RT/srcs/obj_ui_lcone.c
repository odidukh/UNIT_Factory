...
/*   Updated: 2019/03/19 16:10:17 by oponomar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			init_lcone_ui(t_ui_panel *panel, t_objlst *selected)
{
	selected->ui_form_amount = 12;
	kiss_label_new(&selected->title, &panel->panel, "Limited cone",
					UI_STEP_X, UI_Y);
