...
SDL_Color kiss_lightgray = {211, 211, 211, 255};
SDL_Color kiss_gray = {167, 167, 167, 255};
SDL_Color kiss_darkgray = {122, 122, 122, 255};
SDL_Color kiss_orange = {255, 204, 0, 255};
...
SDL_Renderer* kiss_init(char* title, kiss_array *a, int w, int h)
{
	...
	r += kiss_font_new(&kiss_textfont, "libkiss/res/kiss_font.ttf", a,
		kiss_textfont_size);
	r += kiss_font_new(&kiss_buttonfont, "libkiss/res/kiss_font.ttf", a,
		kiss_buttonfont_size);
	r += kiss_image_new(&kiss_normal, "libkiss/res/kiss_normal.png", a, renderer);
	r += kiss_image_new(&kiss_prelight, "libkiss/res/kiss_prelight.png", a, renderer);
	r += kiss_image_new(&kiss_active, "libkiss/res/kiss_active.png", a, renderer);
	r += kiss_image_new(&kiss_bar, "libkiss/res/kiss_bar.png", a, renderer);
	r += kiss_image_new(&kiss_vslider, "libkiss/res/kiss_vslider.png", a, renderer);
	r += kiss_image_new(&kiss_hslider, "libkiss/res/kiss_hslider.png", a, renderer);
	r += kiss_image_new(&kiss_up, "libkiss/res/kiss_up.png", a, renderer);
	r += kiss_image_new(&kiss_down, "libkiss/res/kiss_down.png", a, renderer);
	r += kiss_image_new(&kiss_left, "libkiss/res/kiss_left.png", a, renderer);
	r += kiss_image_new(&kiss_right, "libkiss/res/kiss_right.png", a, renderer);
	r += kiss_image_new(&kiss_combo, "libkiss/res/kiss_combo.png", a, renderer);
	r += kiss_image_new(&kiss_selected, "libkiss/res/kiss_selected.png", a, renderer);
	r += kiss_image_new(&kiss_unselected, "libkiss/res/kiss_unselected.png", a,
		renderer);
	if (r) {
		kiss_clean(a);
		return NULL;
